...
function setMotorPositions()
    ...
    data[1]=CPGData[1]
    data[2]=CPGData[2]-0.4
    data[3]=CPGData[3]+0.5

    data[4]=CPGData[4]
    data[5]=CPGData[5]-0.4
    data[6]=CPGData[6]+0.5

    data[7]=CPGData[7]
    data[8]=CPGData[8]-0.4
    data[9]=CPGData[9]+0.5

    data[10]=CPGData[10]
    data[11]=CPGData[11]-0.4
    data[12]=CPGData[12]+0.5
...
function initParametersSlide()
    ...
    controlParameters={ 0.0,0.035,0.035, 0.0,0.035,0.035, 0.0,0.0,0.0,  0.1,0.75,4}
...
function sysCall_sensing()
    ...
    sensor_array[i + 4*#joint_array + #body_eularAngles + #body_position + #body_velocity] = math.sqrt(force[1]^2+force[2]^2+force[3]^2)/130.0 --+ ((force[3]/10.0 > 0.1) and 0.5*math.random() or 0.0) --let the value into [0,1] --force[3]/10.0 
    end
